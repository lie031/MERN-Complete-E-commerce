...
import mensCollentionImg from '../../assets/mens-collection.webp'
import womensCollentionImg from '../../assets/womens-collection.webp'
    ...
    <section className='py-16 px-4 lg:px-0'>
      <div className='container mx-auto flex flex-col md:flex-row gap-8'>
        ...
        <div className='relative flex-1'>
          <img src={womensCollentionImg} alt='womens collection' className='w-full h-[700px] object-cover' />
        ...
        {/* mens collection */}
        <div className='relative flex-1'>
          <img src={mensCollentionImg} alt='mens collection' className='w-full h-[700px] object-cover' />
          <div className='absolute bottom-8 left-8 bg-white/90 p-4'>
